...
create table Topic (
	...
	diggCount INT(9) NOT NULL DEFAULT 0,
...
CREATE TABLE logs (
	...
	actionInfo VARCHAR(280) NOT NULL,
	actionTime TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT PK_4 PRIMARY KEY(logId),
	CONSTRAINT FK_4 FOREIGN KEY(userId) REFERENCES User(userId)
)